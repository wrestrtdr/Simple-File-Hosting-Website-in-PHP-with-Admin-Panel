...
<body>
	...
	<section role="navigation">
		...
		<nav id="main-nav">
			<ul>
				<li class="current"><a href="index.php" title="" class="dashboard no-submenu">File Manager</a></li> <!-- Use class .no-submenu to open link instead of a sub menu-->
											...
											{											
												foreach($details_files as $value => $temp)
												{
													if(file_exists('../uploads/'.$temp['file_code']))
													{
														...
														<td><a href="../index.php?delete='.$temp['file_delete_id'].'" target="_New" title="Delete File" >delete</a></td>
														</tr>';
													}
												}
											}
