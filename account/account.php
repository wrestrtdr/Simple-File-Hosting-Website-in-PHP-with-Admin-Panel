...
<body>
	...
	<section role="navigation">
		...
		<section id="user-info">
			...
			<div>
				<a href="#" title="Username"><?php echo $_SESSION['user']['u_id'] ?></a>
				<em>User</em>
				<ul>
					<li><a class="button-link" href="#" title="This is my title!" rel="tooltip">account details</a></li>
					<li><a class="button-link" href="../logout.php" title="And this is Sparta!" rel="tooltip">logout</a></li>
				</ul>
			</div>
		</section>
		<!-- /User Info -->
		...
		<nav id="main-nav">
			<ul>
				<li><a href="index.php" title="" class="dashboard no-submenu">Dashboard</a></li> <!-- Use class .no-submenu to open link instead of a sub menu-->
	...
	<section role="main">
		...
		<section id="widgets-container">
			...
			<!-- Add New Widget Box --><!-- /Add New Widget Box -->
